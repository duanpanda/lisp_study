...
and some O((n**a)*log(n)*log(log n)) if using the SchÃ¶nhageâ€“Strassen algorithm, etc.
|#
...
(such as with GÃ¶del's theorem); they can also be used to escape the strictures
